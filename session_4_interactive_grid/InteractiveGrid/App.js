...
Ext.define('CustomApp', {
    ...
    launch: function() {
      ...
      console.log('interactive grid refactored');     // see console api: https://developers.google.com/chrome-developer-tools/docs/console-api
    ...
    // construct filters for defects with given iteration/severity values
    _getFilters: function(iterationValue, severityValue) {
      ...
      console.log('iteration filter', iterationFilter, severityFilter, iterationFilter.toString());
